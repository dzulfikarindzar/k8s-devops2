...
export KOPS_STATE_STORE=s3://k8s-example-store
...
```bash
kops create cluster --cloud=aws --zones=us-west-1a --name=$NAME --node-size=t2.small --master-size=t2.small --dns-zone=k8s.example.com --dns private
